     ...
     <?php 
      ...
      <div class="container">
		...
		if($objetivo == NULL){ // verifica objetivo?>
			<p class="lead">
				Para liberar a escolha dos desafios, precisamos que você nos diga qual objetivo você quer alcançar com este treinamento.
			</p>
			<p class="lead">
				Fizemos um vídeo explicativo para te ajudar a definir este objetivo.
			</p>
			<p class="lead">
				<a href="objetivo.php">Assistir vídeo!</a>
			</p>
	        <p>
	        	<a class="btn btn-lg btn-success" href="objetivo.php" role="button">Definir objetivo</a>
	        </p>
		...
		?>
				<p class="lead">
					O seu treinador ainda não avaliou o seu objetivo.
				</p>
				<p class="lead">
					É importante que o seu treinador avalie seu objetivo antes de iniciar, para que a escolha dos níveis dos desafios seja apropriada.
				</p>
				<p class="lead">
					Assim que ele classificar o seu objetivo, você poderá escolher os desafios.
				</p>
				<p class="lead">
					Não se preocupe, ele não vai demorar para fazer esta avaliação! =)
				</p>
		...
		?>
				<p class="lead">
					O seu treinador avaliou o seu objetivo <strong> "<?php echo $obj['objetivo'] ?>"</strong> como de nível <strong><?php echo $obj['nivel']; ?></strong>
					<a href="http://ialtaperformance.com/downloads/baixar.php?arquivo=7-niveis-profissionais-pessoais.png"></a>
				</p>
					
					<p class="lead">
						O seu treinamento irá iniciar na segunda-feira seguinte que você escolheu o seu primeiro desafio.
					</p>					
					<p class="lead">
						Uma vez que o treinamento é iniciado, as datas não poderão ser alteradas.
					</p>					
					<p class="lead">
						Será um total de 10 fases, com duração aproximada de 4 meses.
					</p>
					<p class="lead">
						[INSERIR VIDEO DA IMPORTANCIA DOS DESAFIOS...]
					</p>
					<p class="lead">
						Nessa fase inicial, você deve pegar um desafio de nível 1:
					</p>
 		...
 		?>
  	 	...
  	 	<p class="lead">
  	 		<a href="http://ialtaperformance.com/downloads/baixar.php?arquivo=7-niveis-profissionais-pessoais.png"> Clique aqui</a> para entender mais sobre os níveis que nós trabalhamos.
  	 	</p>
  	 	<p class="lead">
	...
	for($i = $sem; $i <= $sem  AND $i > 0; $i--){
		...
		<tr>
          ...
          <?php	} //if ?> 
			...
			<?php }//if			
   			...
   			<!--
   				<p class="lead">O seu treinamento terminará em <strong> <?php echo exibirDataBr($des[1]['inicio']) ?>  a <?php echo exibirDataBr($des[16]['fim']) ?> </strong>.
   				</p>
   			-->     
   			
   			<!--
   				<p class="lead">
   					Serão 16 semanas com 10 fases.
   				</p>
   			-->  		
		...
		?>
			...
			<div class="jumbotron" style="margin-top:5%; padding-top:0px;">
			 <!--<p class="lead">Hoje você está na Fase <b>-->
			 	<?php //$fase_atual = verificaFase($obj['id']);
						//echo $fase_atual;
 				?> 
			 ...
			 <p class="lead">
			 	Para a sua próxima fase (<strong>Fase <?php $fase_mostra = $fase_atual + 1;	echo $fase_mostra;
 ?></strong>), você deve <strong>manter o seu desafio inicial de Nível 1</strong>, e ainda escolher um novo desafio do nível do seu objetivo <em>(<?php echo "lembrando que o seu objetivo é <strong> \"".$objetivo['objetivo']."\"</strong> e o treinador classificou ele como Nível " . $objetivo['nivel'] ?>)</em>.
 			</p>
 			 
			 <p class="lead">
			 	O seu total de desafios para essa próxima fase será 2.
			 </p>
			 
			 <p class="lead">
			 	Abaixo estão listados os desafios do nível do seu objetivo pra você já dar uma olhada.
			 </p>
			</div>
			...
			<div class="jumbotron" style="margin-top:5%; padding-top:0px;">
				<p class="lead" style="margin-top:3%;">
					Hoje você está na <b>Fase <?php $fase_atual = verificaFase($obj['id']); echo $fase_atual; ?></b>.
 				</p>
 				
				 <p class="lead">
				 	Para a sua próxima fase (<strong>Fase <?php $fase_mostra = $fase_atual + 1;	echo $fase_mostra;
 ?></strong>), você deve <strong>parar com um dos desafios que estava</strong>, e ainda escolher <strong>DOIS NOVOS</strong> desafios, sendo um do nível do seu objetivo <em>(<?php echo $objetivo['objetivo'] . ", " . "Nível: " . $objetivo['nivel'] ?>)</em> e um do nível abaixo do seu objetivo <em>(nível <?php echo $objetivo['nivel'] - 1; ?>)</em>.
 				</p> 
				 
				 <p class="lead">
				 	O seu total de desafios para essa próxima fase será 3.
				 </p>
				 <p class="lead">
			...
			<div class="jumbotron" style="margin-top:5%; padding-top:0px;">
				<p class="lead" style="margin-top:3%;">
					Hoje você está na <b>Fase <?php $fase_atual = verificaFase($obj['id']); echo $fase_atual; ?></b>.</p>
				 <p class="lead">Para a sua próxima fase (<strong>Fase <?php $fase_mostra = $fase_atual + 1; echo $fase_mostra; ?></strong>), você deve <strong>PARAR com UM dos desafios que estava</strong>, deve MANTER DOIS desafios, e ainda escolher <strong>DOIS NOVOS</strong> desafios, sendo um do nível do seu objetivo <em>(<?php echo $objetivo['objetivo'] . ", " . "Nível: " . $objetivo['nivel'] ?>)</em>, um do nível abaixo do seu objetivo <em>(nível <?php echo $objetivo['nivel'] - 1; ?>)</em> e um do nível acima do seu objetivo <em>(nível <?php echo $objetivo['nivel'] + 1; ?>)</em>. 
				 </p>
				 
				 <p class="lead">
				 	O seu total de desafios para essa próxima fase será 5.
				 </p>
			...
			<div class="jumbotron" style="margin-top:5%; padding-top:0px;">
				<p class="lead" style="margin-top:3%;">
				 ...
				 <p class="lead">Para a sua próxima fase (<strong>Fase <?php $fase_mostra = $fase_atual + 1; echo $fase_mostra; ?></strong>), você deve <strong>PARAR com DOIS dos desafios que estava</strong>, deve MANTER TRÊS desafios, e ainda escolher <strong>CINCO NOVOS</strong> desafios, sendo pelo menos um do nível do seu objetivo <em>(<?php echo $objetivo['objetivo'] . ", " . "Nível: " . $objetivo['nivel'] ?>)</em>, pelo menos um do nível abaixo do seu objetivo <em>(nível <?php echo $objetivo['nivel'] - 1; ?>)</em> e pelo menos um do nível acima do seu objetivo <em>(nível <?php echo $objetivo['nivel'] + 1; ?>)</em>.
				 </p> 
				 
				 <p class="lead">
				 	O seu total de desafios para essa próxima fase será 8.
				 </p>
			...
			<div class="jumbotron" style="margin-top:5%; padding-top:0px;">
				<p class="lead" style="margin-top:3%;">
				 ...
				 <p class="lead">
				 	Para a sua próxima fase (<strong>Fase <?php $fase_mostra = $fase_atual + 1;	echo $fase_mostra; ?></strong>), você deve <strong>PARAR com TRÊS dos desafios que estava</strong>, deve MANTER CINCO desafios, e ainda escolher <strong>OITO NOVOS</strong> desafios, podendo ser de qualquer nível, desde que tenha pelo menos um de cada nível.
				 </p> 
				 
				 <p class="lead">
				 	O seu total de desafios para essa próxima fase será 13.
				 </p>
			...
			<div class="jumbotron" style="margin-top:5%; padding-top:0px;">
				<p class="lead" style="margin-top:3%;">
				 ...
				 <p class="lead">
				 	Para a sua próxima fase (<strong>Fase <?php $fase_mostra = $fase_atual + 1;	echo $fase_mostra; ?></strong>), você deve <strong>PARAR com CINCO dos desafios que estava</strong>, deve MANTER OITO desafios, e ainda escolher <strong>TREZE NOVOS</strong> desafios, podendo ser de qualquer nível, desde que tenha pelo menos um de cada nível. 
				 </p>
				 
				 <p class="lead">
				 	O seu total de desafios para essa próxima fase será 21.
				 </p>
				...
				<div class="jumbotron" style="margin-top:5%; padding-top:0px;">
					<p class="lead" style="margin-top:3%;">
				 	...
				 	<p class="lead">
				 		Para a sua próxima fase (<strong>Fase <?php $fase_mostra = $fase_atual + 1;	echo $fase_mostra; ?></strong>), você deve <strong>PARAR com OITO dos desafios que estava</strong>, deve MANTER TREZE desafios, e ainda escolher <strong>VINTE E UM NOVOS</strong> desafios, podendo ser de qualquer nível, desde que tenha pelo menos um ou dois de cada nível.
				 	</p>
				 	 
				 	<p class="lead">
				 		O seu total de desafios para essa próxima fase será 34.
				 	</p>
				...
				<div class="jumbotron" style="margin-top:5%; padding-top:0px;">
					<p class="lead" style="margin-top:3%;">
				 	...
				 	<p class="lead">Para a sua próxima fase (<strong>Fase <?php $fase_mostra = $fase_atual + 1;	echo $fase_mostra; ?></strong>), você deve <strong>PEGAR 14 DESAFIOS</strong>.
				 	</p>
				 	
				 	<p class="lead">
				 		É importante que você considere parar com os desafios que se tornaram fáceis para você. Mantenha os que ainda estão desafiadores, e escolha novos desafios tão desafiadores quanto estes.
				 	</p>
				 	
				 	<p class="lead">
				 		Você terá 14 desafios nessa próxima fase.
				 	</p>
				...
				<div class="jumbotron" style="margin-top:5%; padding-top:0px;">
					<p class="lead" style="margin-top:3%;">
						Hoje você está na <b>Fase <?php $fase_atual = verificaFase($obj['id']); echo $fase_atual;
 ?></b>.
 					</p>
				 	
				 	<p class="lead">Para a sua próxima fase (<strong>Fase <?php $fase_mostra = $fase_atual + 1;	echo $fase_mostra; ?></strong>), você deve <strong>PEGAR 7 DESAFIOS</strong>.
				 	</p>
				 	
				 	<p class="lead"> 
				 		À partir de agora, você está pronto para seguir se desafiando por conta própria. Mantenha pelo menos 7 desafios e renove a cada 14 dias.
				 	</p>
				 
				 	<p class="lead">
				 		Fazendo isso, você continuará desfrutando do estilo de vida em Alta Performance.
				 	</p>
				...
				<div class="jumbotron" style="margin-top:5%; padding-top:0px;">
					<p class="lead">
						O seu treinamento chegou ao fim. [Mensagem]
					</p>
				</div>
				...
				<p class="lead">
					Ops..parece que o sistema buscou uma fase que não existe. Fale com seu treinador pra que ele possa te dar o suporte necessário enquanto a equipe técnica resolve esse probleminha..
				</p>
     ...
     </div> <!-- fecha div class = jumbotron do inicio da página -->
 ...
 ?>
    ...
    <div class="container">
 		<?php include '../inc/fixed-navbar-user.php'; ?>
      	<?php include '../inc/menu-principal.php'; ?>
			...
			<?php $des = retornaSemanas($obj['data_inicio']); ?>
  	 		...
  	 		<p class="lead">
  	 			O seu treinador avaliou o seu desafio <strong> "<?php echo $obj['objetivo'] ?>"</strong> como de nível <strong><?php echo $obj['nivel']; ?></strong>.
  	 		</p>    
		...
		switch ($fase_atual) {
			case '0' :?>
				<p class="lead">
					Para iniciar o seu treinamento, você deve escolher um desafio de Nível 1.
				</p>
			...
			?>
				...
				<p class="lead" style="margin-top:3%;">
					Hoje você está na Fase <b><?php $fase_atual = verificaFase($obj['id']);	echo $fase_atual; ?> </b>.</p>
				 
				<p class="lead">
					Para a sua próxima fase (<strong>Fase <?php $fase_mostra = $fase_atual + 1;	echo $fase_mostra; ?></strong>), você deve <strong>manter o seu desafio inicial de Nível 1</strong>, e ainda escolher um novo desafio do nível do seu objetivo <em>(<?php echo $objetivo['objetivo']; ?>)</em>.
				</p> 
			...
			?>
				...
				<p class="lead">
					Para a sua próxima fase (<strong>Fase <?php $fase_mostra = $fase_atual + 1;	echo $fase_mostra; ?></strong>), você deve <strong>parar com um dos desafios que estava</strong>, e ainda escolher <strong>DOIS NOVOS</strong> desafios, sendo um do nível do seu objetivo <em>(<?php echo $objetivo['objetivo'] . ", " . "Nível: " . $objetivo['nivel'] ?>)</em> e um do nível abaixo do seu objetivo <em>(nível <?php echo $objetivo['nivel'] - 1; ?>)</em>.
				</p> 
			...
			?>
				...
				<p class="lead" style="margin-top:3%;">Hoje você está na <b>Fase <?php $fase_atual = verificaFase($obj['id']); echo $fase_atual; ?></b>.
				</p>
			...
			?>
				...
				<p class="lead">
					Para a sua próxima fase (<strong>Fase <?php $fase_mostra = $fase_atual + 1;	echo $fase_mostra; ?></strong>), você deve <strong>PEGAR 14 DESAFIOS</strong>.
				</p>
			...
			?>
				...
				<p class="lead">
					Para a sua próxima fase (<strong>Fase <?php $fase_mostra = $fase_atual + 1;	echo $fase_mostra;
 ?></strong>), você deve <strong>PEGAR 7 DESAFIOS</strong>.
 				</p>
			...
			?>
				...
				<p class="lead">
					O seu treinamento chegou ao fim.
				</p>
...
</div> <!-- fecha o jumbotron da linha 692 -->
	...
	if(isset($_POST['insere'])){ //insere
		...
		foreach($_POST as $x => $valor){
			...
			if(!preg_match('/[^0-9]/',$x)){ //verifica se é um número
				array_push($caixa, $x);
			}//finaliza if linha 1045
		}//finaliza if linha 1043
...
<script>
	function validaCorpos(){
		...
		<?php } //finaliza while linha 1144 ?>
	} //finaliza funcao validaCorpos
    ...
    </div> <!-- jumbotron linha 1120 -->
    	
	<?php } //finaliza o if($num) linha 1138 ?>
    <?php } //finaliza o if (verifica...) linha 1133  ?>
...
<?php break; ?>
<?php break; ?>
<?php } //fecha o switch inicial da linha 35 ?>
