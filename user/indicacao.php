    ...
    <div class="jumbotron">
        ...
        <div style="width:70%;text-align: left; margin:0 auto;">
            <form action="indicacao-enviada.php" method="POST" enctype="multipart/form-data" name="formIndica" onsubmit="return validaIndicacao();">
                ...
                Mensagem:
                <br />
                <textarea class="form-control" name="msgIndica" rows="7" cols="30" id="msgIndica" placeholder="Se preferir, conte-nos por quê está convidando este amigo."></textarea>
 				<br />
                <br />
                <input class="btn btn-primary center-block" type="submit" value="Convidar!" />
